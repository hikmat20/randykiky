...
if (isset($_POST)) {
    ...
    $query      = mysqli_query($conn, "INSERT INTO greeting(order_id,customer_id,`name`,greeting,present,created_at) VALUES('$order_id','$customer_id','$name','$greeting','$present','$date')");
    ...
    if (!$query) {
        ...
        $sql            = "SELECT * FROM greeting where customer_id ='C2208001' and `status`='1' order by created_at DESC";
